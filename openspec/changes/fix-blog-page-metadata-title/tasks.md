...
- [ ] **Local verification** — Start dev server, open blog detail pages, confirm tab title shows article title (not "文章未找到"), check page source for correct `<title>`, `og:title`, `twitter:title`.
