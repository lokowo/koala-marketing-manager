...
const MODES: {
...
}[] = [
  {
    ...
    desc: '评估 PhD 路径可行性',
    placeholder: '告诉我你的背景、均分、目标方向……',
    welcome: '你好呀！我是考拉学长 很高兴见到你。\n\n在路径评估模式下，我会帮你梳理：\n1. 学术兴趣与长期目标\n2. 背景匹配的项目方向\n3. 申请节奏与时间规划\n\n先告诉我你的专业方向和目前的学历阶段？',
    initialReplies: ['先聊学术方向', '先聊工业方向', '帮我看跨专业可行性'],
  },
  {
    key: 'research',
    label: '科研深潜',
    ...
    desc: '深挖教授研究 + ARC 经费信号',
    placeholder: '你想研究什么方向？或者问我某位教授……',
    welcome: '科研深潜模式已激活 🔬\n\n我会实时检索 Semantic Scholar + arXiv + OpenAlex 论文，所有论文引用都有真实 DOI 链接。\n\n你想了解哪个研究方向或教授？',
  },
  {
    key: 'chat',
    label: '陪伴',
    ...
    desc: '不焦虑，你有我陪',
    placeholder: '有什么想聊的都可以说……',
    welcome: '嗨～有什么想聊的都可以说 💬\n\nPhD 申请很孤独，我在这里陪你。焦虑、迷茫、兴奋——都可以分享。',
  },
  {
    key: 'write',
    label: '文案',
    ...
    desc: '套磁信 · SOP · 研究计划',
    placeholder: '需要写 SOP、个人陈述，还是套磁信？',
    welcome: '✍️ 文案助手\n\n我可以帮你写套磁信、SOP、Research Proposal。\n\n先告诉我你想联系哪位教授？\n或者我根据你的背景自动推荐最匹配的教授。',
    initialReplies: ['🎯 自动匹配教授', '🔍 我要指定教授', '📝 先写 RP 大纲'],
  },
];
