...
const MODES: {
...
}[] = [
  {
    ...
    welcome: '你好！我是考拉学长 🐨\n\n在申请规划模式下，我会帮你：\n• 评估你的 PhD 申请竞争力\n• 规划申请时间线\n• 推荐最适合的学校和导师\n\n先告诉我你的专业背景和目前学历阶段？',
    initialReplies: ['本科 985/211 在读', '已有硕士学位', '双非背景想冲 Go8', '转专业申请'],
  },
  {
    key: 'research',
    label: '🔬 找导师',
    ...
    desc: '从 2,847 位教授中精准匹配',
    placeholder: '告诉我你的研究兴趣，或问某位教授……',
    welcome: '告诉我你的研究兴趣，我从 2,847 位澳洲教授中帮你精准匹配 🔬\n\n可以描述研究方向、感兴趣的课题，或者直接问某位教授的情况。',
    initialReplies: ['AI · 机器学习方向', '生物医学方向', '商科 · 金融方向', '工程 · 材料方向'],
  },
  {
    key: 'chat',
    label: '💬 自由聊天',
    ...
    welcome: '嗨！有任何关于澳洲读博的问题都可以问我 💬\n\nPhD 申请路上的焦虑、迷茫、疑惑——我都在这里陪你。',
    initialReplies: ['奖学金申请攻略', '签证问题', '生活费预算', '读博时间线'],
  },
  {
    key: 'write',
    label: '✉️ 写套磁信',
    ...
    welcome: '给我一位教授的名字或链接，我帮你写一封专业的套磁信 ✉️\n\n我会引用该教授的真实论文，写出有针对性的内容，而不是模板化的群发邮件。',
    initialReplies: ['我有目标教授', '帮我先找教授再写信', '修改我的草稿', '写 SOP 个人陈述'],
  },
];
