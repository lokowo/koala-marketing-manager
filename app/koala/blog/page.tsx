          ...
          {[1, 2, 3, 4].map(i => (
            <div key={i} className="rounded-2xl p-4 animate-pulse" style={{ background: 'linear-gradient(180deg, #111c28, #0d1520)', border: '1px solid rgba(201,169,110,0.08)' }}>
              <div className="flex gap-3">
                <div className="w-20 h-20 rounded-xl flex-shrink-0" style={{ background: 'rgba(201,169,110,0.08)' }} />
        ...
        <div className="px-5 space-y-3">
          {posts.map(post => (
            <Link
              ...
              className="block rounded-2xl p-3.5 no-underline transition-transform active:scale-[0.98]"
              style={{
