  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <button onClick={addLayer} disabled={config.layers.length >= 5} className="text-[11px] px-2.5 py-1 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700/50 disabled:opacity-40">+ 添加文字</button>
      </div>
                    ...
                    <div className="flex gap-1.5 flex-wrap">
                      {[
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg text-[11px] border border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700/50 hover:border-[#c9a96e] transition-colors disabled:opacity-40"
                        >
