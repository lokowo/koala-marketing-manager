  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">管理 AI 的知识库内容和向量索引</p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <h2 className="text-lg font-semibold text-gray-900 mb-3">测试搜索</h2>
        ...
        {searchResults && (
          <pre className="mt-3 bg-gray-50 p-3 rounded text-xs whitespace-pre-wrap">{searchResults}</pre>
        )}
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="p-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <select className="text-sm border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none">
        ...
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500">知识库暂无内容</p>
            <p className="text-sm text-gray-400 mt-1">运行 <code className="bg-gray-100 px-1 rounded">knowledge_builder.js</code> 构建知识库</p>
          </div>
        ) : (
            ...
            {chunks.slice(0, 20).map(chunk => (
              <div key={chunk.id} className="p-4 hover:bg-gray-50">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm font-medium text-gray-700">{chunk.source_title}</span>
                </div>
