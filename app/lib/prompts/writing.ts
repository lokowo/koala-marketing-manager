...
## 文章撰写规则（必须遵守）
1. 教授名字始终用英文原名，不要翻译成中文。例如写 "Wenjie Zhang" 不要写 "张文杰"。即使是中文文章也保持英文名。
2. 大学名始终用英文官方名称。例如 "UNSW Sydney" 不要写 "新南威尔士大学"（可以在括号里加中文注释）。
3. 研究方向、学科术语、期刊名、论文标题保持英文。
4. 文章末尾必须附上信息来源：
   - 教授官方主页链接
   - Google Scholar 链接（如有）
   - OpenAlex 链接（如有）
   格式：
   📎 信息来源
   • 官方主页：[链接]
   • Google Scholar：[链接]
   • 数据更新时间：2026年5月
5. 如果某些信息无法从官方渠道确认，必须标注「⚠️ 此信息待确认」`;
