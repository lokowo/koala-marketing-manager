        ...
        <div style={{ width: 750, height: 1334, display: 'flex', flexDirection: 'column', position: 'relative', fontFamily: 'NotoSansSC' }}>
          ...
          <div style={{ position: 'relative', width: 750, height: 1334, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: 24 }}>
              ...
              <div style={{ fontSize: 14, fontWeight: 700, color: '#FFFFFF', marginTop: 20 }}>扫码注册</div>
              <div style={{ fontSize: 14, color: '#FFFFFF', marginTop: 20 }}>📷 请使用手机相机扫码（微信扫码可能无法登录）</div>
              <div style={{ fontSize: 14, fontWeight: 700, color: '#FFFFFF', marginTop: 20, background: 'rgba(255,255,255,0.1)', padding: '4px 14px', borderRadius: 8, letterSpacing: 2 }}>{code}</div>
            </div>

            {/* Footer */}
            <div style={{ display: 'flex', width: 750, justifyContent: 'center', marginTop: 24 }}>
              <div style={{ fontSize: 14, color: '#FFFFFF', letterSpacing: 1 }}>www.koalaphd.com</div>
            </div>
          </div>
        </div>
      ),
