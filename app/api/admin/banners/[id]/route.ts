...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const allowedFields = ['image_url', 'image_alt', 'click_action', 'click_url', 'modal_title', 'modal_content', 'modal_image_url', 'overlay_title', 'overlay_subtitle', 'overlay_config', 'is_active', 'sort_order', 'start_date', 'end_date'];
